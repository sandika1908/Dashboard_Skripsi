...
<title>User List - Interlink Data Center Sejahtera</title>
...
<a class="me-3" href="process.php?delete=<?php echo $result['id_access']; ?>" onclick="return confirm('Are you sure for delete <?php echo addslashes($result['username']); ?> as a <?php echo addslashes($result['role']); ?> ?');">
